...
namespace AdvancedEventManagementSystemCSharp
{
    public partial class BookingStatus : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'eventVDataSet2.book_event' table. You can move, or remove it, as needed.
            this.book_eventTableAdapter.Fill(this.eventVDataSet2.book_event);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            using (SqlConnection con1 = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\H110\Desktop\AdvancedEventManagementSystemCSharp\AdvancedEventManagementSystemCSharp\EventV.mdf;Integrated Security=True"))
            {
                ...
                string str2 = "SELECT * FROM book_event where e_type='"+comboBox1.SelectedText  +"'";
                SqlCommand cmd2 = new SqlCommand(str2, con1);
                SqlDataAdapter da = new SqlDataAdapter(cmd2);
                DataTable dt = new DataTable();
                da.Fill(dt);
